...
const res = \`                                <div key={player.id} className={\`\${theme.bg} border \${theme.border} rounded-[28px] p-[22px] relative transition-all flex flex-col \${theme.glow} mx-auto\`} style={{ width: '330px', height: '430px' }}>
                                   {/* Rank Badge */}
